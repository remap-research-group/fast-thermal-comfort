...
base_source_data_dir = f"/storage/project/r-rbasu31-0/shared/{CITY}/01_Input_UTCI/{SCENARIO}/{TIME}"
temp_base_dir = f"/storage/project/r-rbasu31-0/shared/{CITY}/02_IntUTCI/{SCENARIO}/{TIME}"
...
PATHS_CONFIG = {
    "TMRT":     os.path.join(base_source_data_dir, f"Tmrt_2023_208_{TIME}00D.tif"),
    "UROCK":    os.path.join(base_source_data_dir, f"2023_208_{TIME}D_hot_urock_wind_field_WS.tif"),
    "BUILDING": os.path.join(base_source_data_dir, "buildings.tif"),
    "MET":      os.path.join(base_source_data_dir, "metforcing.txt"),
}

# Output directories
final_output_base_dir = f"/storage/project/r-rbasu31-0/shared/{CITY}/03_Output_UTCI/{SCENARIO}/{TIME}"
