...
qgis_prefix_path = "/storage/home/hcoda1//hyu483/conda_envs/qgis332"
...
base_source_data_dir = "/storage/project/r-rbasu31-0/hyu483/Test_UMEP/SOLWEIG_input"
temp_base_dir = "/storage/project/r-rbasu31-0/hyu483/Test_UMEP/SOLWEIG_Int_G"
...
# Output directories
final_output_base_dir = "/storage/project/r-rbasu31-0/hyu483/Test_UMEP/SOLWEIG_Output_G"
...
PATHS_CONFIG = {
    "bDSM": os.path.join(base_source_data_dir, "DSM_26919.tif"),
    "cDSM": os.path.join(base_source_data_dir, "cDSM_26919.tif"),
    "dem": os.path.join(base_source_data_dir, "DEM_26919.tif"),
    "wall_aspect": os.path.join(base_source_data_dir, "wall_aspect_26919.tif"),
    "wall_height": os.path.join(base_source_data_dir, "wall_height_26919.tif"),
    "lc": os.path.join(base_source_data_dir, "LULC_26919.tif"),
...
SOLWEIG_FIXED_PARAMS = {
    ...
    'POSTURE': 0, 'CYL': True, 'ONLYGLOBAL': True, 'UTC': -6,
