...
INPUT_DIR = Path("/storage/project/r-rbasu31-0/shared/Metro_Boston")
OUTPUT_DIR = Path("/storage/scratch1/2/glin71/UROCK/outputs/Metro_Boston/Clipped_Boston")
CLIP_GEOJSON = Path("clipped_boundaries/chelsea_5k.geojson")   # change this
