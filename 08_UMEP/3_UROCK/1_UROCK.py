...
data_dir = './UROCK/input'
output_dir = './UROCK_output'
	
## Need to process to convert geojson to shp file for tiling ##
buildings_path = os.path.join(data_dir, 'building_26986.shp') # should be in .shp
veg_path = os.path.join(data_dir, 'veg_26986.shp') # should be in .shp
template_rast_path = os.path.join(data_dir, "../DSM_26986_2.tif")
building_height_col = 'bd_h' # column name of building height
veg_height_col = 'mean_h' # column name of veg height
